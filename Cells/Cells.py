...
class Cell():
    """
        Parent class describing how each cell type is built
    """
    def __init__(self, gid: int,
                 x: float=0., # cartesian coordinates
                 y: float=0.,
                 z: float=0.,
                 theta: float=0., # cell rotation
                 x_intrinsic: float=None, # intrinsic coordinates
                 y_intrinsic: float=None,
                 x_unfolded: float=None, # unfolded coordinates
                 y_unfolded: float=None) -> None:
        self._gid = gid
        ...
        self.x_unfolded = x_unfolded
        self.y_unfolded = y_unfolded
...
class PyramidalCell(Cell):
    """
        Template for pyramidal cells taken from Bezaire et al. 2016
    """
    name = "PyramidalCell"
    def __init__(self, gid_soma: int, 
                 ...
                 x_unfolded: float=None, # unfolded coordinates
                 y_unfolded: float=None) -> None:
        super().__init__(gid_soma, x, y, z, theta, x_intrinsic, y_intrinsic, x_unfolded, y_unfolded)
...
class BasketCell(Cell):
    """
        Template for basket cells taken from Bezaire et al. 2016
    """
    name = "BasketCell"
    def __init__(self, 
                 gid: int, 
                 ...
                 x_unfolded: float=None, # unfolded coordinates
                 y_unfolded: float=None) -> None:
        super().__init__(gid, x, y, z, theta, x_intrinsic, y_intrinsic, x_unfolded, y_unfolded)
    ...
    def _setup_subsections(self):
        ...
        # self.proximal_apical.append(self.dend2) # removed because connections on dend1 and dend6 seemed to enhance gamma activity
...
class OLMCell(Cell):
    """
        Template for OLM cells taken from Bezaire et al. 2016
    """
    name = "OLMCell"
    def __init__(self, gid: int,
                 x: float=0., # Cartesian coordinates
                 y: float=0.,
                 z: float=0.,
                 theta: float=np.pi, # cell rotation
                 x_intrinsic: float=None, # intrinsic coordinates
                 y_intrinsic: float=None,
                 x_unfolded: float=None, # unfolded coordinates
                 y_unfolded: float=None) -> None:
...
class SchafferCollateral(Cell):
    """
        Myelinated axon template using MRG axon of McIntyre 2002
    """
    ...
    def __init__(self, gid: int, 
                 gid_last_node: int,
                 nodes_coordinates: np.array, # Cartesian coordinates of each node of Ranvier
                 x_intrinsic_last_node: float, # intrinsic coordinates of last node
                 y_intrinsic_last_node: float,
                 x_unfolded_last_node: float, # unfolded coordinates of last node for connection purposes
                 y_unfolded_last_node: float,
                 x: float=0., # Cartesian coordinates of first node
                 y: float=0.,
                 z: float=0.,
                 theta: float=0, # rotation
                 x_intrinsic: float=None, # intrinsic coordinates of first node
                 y_intrinsic: float=None,
                 x_unfolded: float=None, # unfolded coordinates of first node
                 y_unfolded: float=None) -> None:
        ...
        self.x_unfolded_last_node = x_unfolded_last_node
        self.y_unfolded_last_node = y_unfolded_last_node
