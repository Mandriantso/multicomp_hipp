...
if rank == 0:
    ...
    with open(os.path.join(dirs["save_dir"], "output.txt"), "w") as f:
        ...
        f.write("\nsca - pyr weight : {}\n".format(settings.w_CA3_CA1[0]*1.0))
    ...
    save_specgram(os.path.join(dirs['figures'], 'specgram_0_50.png'), [tv_pyr, tv_bc, tv_olm, tv_sca], [fv_pyr, fv_bc, fv_olm, fv_sca], [pspec_pyr, pspec_bc, pspec_olm, pspec_sca], ["pyramidal cells", "basket cells", "olm cells", "schaffer collaterals"], ylim=[0, 50], **git_kwargs)
    save_specgram(os.path.join(dirs['figures'], 'specgram_1s.png'), [tv_pyr, tv_bc, tv_olm, tv_sca], [fv_pyr, fv_bc, fv_olm, fv_sca], [pspec_pyr, pspec_bc, pspec_olm, pspec_sca], ["pyramidal cells", "basket cells", "olm cells", "schaffer collaterals"], xlim=[3, 4], ylim=[0, 100], **git_kwargs)
