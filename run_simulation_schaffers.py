...
if rank == 0:
    ...
    with open(os.path.join(dirs["save_dir"], "output.txt"), "w") as f:
        ...
        f.write("Je refais les expériences w_sca * 0 et offset (0, 50) pour un courant oscillatoire à 0.2nA")
        f.write("Schaffers déconnectés du réseau pour voir s'il y a toujours une backprop sans cellules")
